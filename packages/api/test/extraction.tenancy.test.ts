...
// scoping.
//
// ## Expected result on an unfixed tree
//
// The four `admits a foreign tenant's row` cases are **RED** at
// `origin/main` 6704836. They are the defect. The negative control at the
// bottom — `catalog.service.ts`'s scoped twin of the same update — is **GREEN**,
// which is what shows the harness can tell the two apart rather than failing
