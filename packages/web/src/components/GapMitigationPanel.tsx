...
export function GapMitigationPanel({
  ...
  const getSeverityInfo = (severity: string) => {
    switch (severity) {
      case 'critical':
        return { icon: '🔴', color: 'border-red-500 bg-red-50', textColor: 'text-red-700', label: 'CRITICAL' };
      case 'moderate':
        return { icon: '🟠', color: 'border-orange-500 bg-orange-50', textColor: 'text-orange-700', label: 'MODERATE' };
      default:
        return { icon: '🟡', color: 'border-yellow-500 bg-yellow-50', textColor: 'text-yellow-700', label: 'MINOR' };
    }
  };
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {isAddressed && (
                        <span className="text-green-600 text-sm">✓ Addressed</span>
                      )}
                    </div>
