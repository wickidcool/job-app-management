...
- **Copy and visual treatment are first-pass, pending design review** — built to the existing design tokens and to the `EmptyState` convention, not to a design spec. Routed to UI/UX Developer and Copywriter for a pass.
