...
- **`ACCESSIBILITY.md:566` corrected** — `- [x] Focus management in modals` claimed this was shipped while zero of six dialogs implemented any of it. Now unchecked, with the five remaining dialogs named.
